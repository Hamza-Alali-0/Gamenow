    ...
    <div class="secondary">
        ...
        <section class="timeline_about card">
            ...
            <div class="contact_Info">
              <p>  Hi <strong> <?php  echo $row['firstname'];?>,</strong><br><br>Welcome! How are you ?
  we hope you're having a great day , <br><br>
we heard a lot about <strong><?php  echo $row['country'];?> </strong> It's a great country. <br>
 Thank your for LOGING IN . <br> To check your info head on to the Info section. <br> And  To change Them head to the settings section. <br>
Don't forget to  try out the games at the GAMES page !  <br><br>

Shoot us a line if you need help! Our support team is always around. <br><br>

  <strong> shepardenterprises0@gmail.com</strong> <br><br>
